Gem::Specification.new do |spec|
  ...
  spec.summary       = 'Pandoc2review is a converter from any document to Re:VIEW format (using Pandoc)'
  spec.description   = 'It provides Re:VIEW Writer/Filter for Pandoc, and Ruby script to make it easier to handle.'
